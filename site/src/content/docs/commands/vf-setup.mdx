...
```
/vf-setup                              # Local, standard enforcement (default)
/vf-setup --global                     # Install for all projects
/vf-setup --strict                     # Strict enforcement config
/vf-setup --permissive                 # Advisory-only enforcement
/vf-setup --force                      # Re-run even if already configured
/vf-setup --platform web               # Pre-configure platform detection
```
