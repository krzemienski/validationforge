...
|------|---------|-------------|
| `--baseline` | false | Save current scores as the new baseline |
| `--compare` | false | Compare current scores against the saved baseline |
| `--ci` | false | Emit machine-readable JSON to stdout with exit codes |
