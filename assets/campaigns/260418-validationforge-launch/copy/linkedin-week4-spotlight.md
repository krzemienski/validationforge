# LinkedIn Post — Week 4 Community Spotlight (Thu May 15)

**Channel:** LinkedIn (native long-form) + personal blog (canonical).
**Send time:** Thu May 15, 8:30am ET.
**Word count:** ~1,030.
**Visual:** real screenshot of one of the spotlighted projects' verification evidence directory or PR (`creatives/screenshots/spotlight-project-evidence.png`). Get permission from the spotlighted project before screenshotting.
**Purpose:** position you as the connector and category-definer, not just the tool author. Highlights other people's good work, which makes you the trusted convener of the Evidence-Based Shipping conversation. This is a key authority-cementing post before the consulting offer escalates in Q3.
...
- This post will get DMs from people wanting to be the fourth, fifth, sixth spotlight. Treat these as content pipeline for future posts. Reply substantively, ask for permission, save the conversations.
- Do NOT speculate about which projects you spotlighted in the comments. Maintain anonymity unless the team explicitly authorized public attribution.
- Tag the spotlighted teams ONLY if they've explicitly asked to be tagged. Default is no tag.
- The post lands soft on the consulting CTA on purpose — the previous week's "five questions" post does the heavy lifting. This post is meant to position you as a connector, not a closer.
