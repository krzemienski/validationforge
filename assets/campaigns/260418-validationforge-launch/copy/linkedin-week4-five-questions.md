# LinkedIn Post — Week 4 Strategic Hero (Mon May 12)

**Channel:** LinkedIn (native long-form) + personal blog (canonical) + cross-post to dev.to + share in Anthropic Discord #showcase as a follow-up to the launch.
**Send time:** Mon May 12, 8:30am ET.
**Word count:** ~3,010.
**Visual:** real screenshot of an org-chart-ish whiteboard with the 5 questions hand-written (`creatives/screenshots/five-questions-whiteboard.png`). Or: clean terminal-style image-quote with the 5 questions listed (1200×627). The whiteboard version converts better; the terminal version produces faster.
**Purpose:** **THIS IS THE CONSULTING-INBOUND POST.** The whole 4-week social calendar exists in service of getting this post in front of the right audience. Engineering leaders who finish this post and have unresolved AI-code-quality anxiety are the highest-value DMs you'll receive. Everything else in the campaign is connective tissue around this.

---

## Title
> 5 questions every engineering leader should ask before adopting agentic dev (and the consulting-grade answers)
...
If you want the open-source verification framework that backs the answers in this post, it's at github.com/krzemienski/validationforge. Free, MIT licensed, no telemetry. It's not the only valid implementation of Evidence-Based Shipping, but it's a working one and the receipts are in the repo.
...
- **This is the consulting-magnet post.** Watch DMs hourly for 48 hours after posting. Reply to substantive inquiries within 4 hours.
- The five-question framing makes the post highly screenshot-friendly. Some readers will quote one section and tag others. Track these — they're how the post spreads beyond your first-degree network.
- If a comment expands on one of the five questions with a sixth (which will happen), engage substantively and consider promoting that comment into a follow-up post.
- DO NOT add a "P.S. did you know I sell consulting" line. The CTA is already in the post body and adding emphasis would tip the post into salesy territory. The post is engineered to make the consulting offer feel like a footnote to the actual substance, not the point of the post.
