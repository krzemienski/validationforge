...
| 9 | `/validate-consensus` | Multi-agent CONSENSUS validation -- spawns independent validators, synthesizes verdicts, resolves disagreements with confidence scoring. |
